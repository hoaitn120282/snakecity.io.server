...
const Reward = db.sequelize.define('reward-histories', RewardSchema);
 ...
 */
Reward.list = function list({ skip = 0, limit = 50 } = {}) {
  return this.findAll({
    limit,
    offset: skip,
    $sort: { id: 1 },
 ...
 */
Reward.prototype.safeModel = function safeModel() {
